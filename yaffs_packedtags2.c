...
/*printf("unpack tags only1\n");*/
	memset(t, 0, sizeof(struct yaffs_ext_tags));
/*printf("unpack tags only2\n");*/
...
/*printf("unpack tags only3\n");*/

	/* Do extra header info stuff */
	if (ptt_copy.chunk_id & EXTRA_HEADER_INFO_FLAG) {
	/*	printf("unpack tags only4\n");*/
	...
	/*	printf("unpack tags only4-1\n");*/

		if(ptt_copy.chunk_id & EXTRA_SHRINK_FLAG )
			t->extra_is_shrink = 1;
		else
			t->extra_is_shrink = 0;
		
		if(ptt_copy.chunk_id & EXTRA_SHADOWS_FLAG)
			t->extra_shadows =  1;
		else
			t->extra_shadows = 0;
	...
	/*printf("unpack tags only5\n");*/
	yaffs_dump_packed_tags2_tags_only(ptt_ptr);
	/*printf("unpack tags only6\n");*/

	yaffs_dump_tags2(t);
/*	printf("unpack tags only7\n");*/
}
