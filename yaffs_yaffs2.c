...
static int yaffs2_rd_checkpt_validity_marker(struct yaffs_dev *dev, int head)
{
	...
	if (ok)
		ok = (cp.struct_type == sizeof(cp)) &&
		    ...
		    (cp.head == ((head) ? 1 : 0));
/*170423 get here */
/*printf("yaffs2_rd_checkpt_validity_marker ok=%d\n",ok);*/
if(ok>0)
	return 1;
else 
	return 0;
...
static int yaffs2_rd_checkpt_data(struct yaffs_dev *dev)
{
	...
	if (ok)
		{/*printf("yaffs2_rd_checkpt_data ok=%d\n",ok);*/
		dev->is_checkpointed = 1;
		return 1;}
	else
		{/*printf("yaffs2_rd_checkpt_data ok=%d\n",ok);*/
...
/*printf("yaffs2_checkpt_restore1 dev->is_checkpointed=%d\n",dev->is_checkpointed);*/
...
/*	printf("yaffs2_checkpt_restore2\n");*/
...
/*	LIST_HEAD(hard_list);*/
	struct list_head hard_list;
	hard_list.prev=&hard_list;
	hard_list.next=&hard_list;	
	...
	for (block_iter = end_iter;
		...
		for (/* c is already initialised */;
			 ...
			 */
			if (yaffs2_scan_chunk(dev, bi, blk, c,                      /*Allocating from*//**//**//**//**//**/
